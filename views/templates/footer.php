<footer class="footer">
    ...
    <div class="footer__copyright">
        <img class="footer__copyright--imagen" src="/build/img/avalos murillo-blanco.png" alt="logo">
        <p class=""> <span class="footer__copyright--regular">- Todos los derechos reservados <?php echo date('Y'); ?></span></p>
    </div>
